...
function draw2(json) {
	var sl2 = document.getElementById("server2_list");
	window.render.servers2(json, sl2);
}
...
function loaded(){
	...
	get();
	jQuery.getJSON(master.list_url, draw2);
}
...
toast(master.root + 'style.css', master.root + 'servers.js', master.root + 'servers2.js', function() {
